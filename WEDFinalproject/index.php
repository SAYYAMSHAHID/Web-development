...
<div id="slider">
    <figure>
    <img src="samsung-galaxy-z-flip4-5g-3_710x395.jpg" alt>
    <img src="gsmarena_003_710x395.jpg" alt>
    <img src="gsmarena_013_710x395.jpg" alt>
    <img src="s02.jpg" alt>
    <img src="s03.jpg" alt>
    </figure>
</div>
    ...
    <div class="card-body">
      <div class="row">
          <div class="col-md-4 mb-4">
              <div class="card">
                <a href=""><img src="samsung-galaxy-a04-1_200x200.jpg"></a>
                  <div class="card-body">
                      <p class="h6">samsung Galaxy A04</p>
                      <div class="stars">
          ...
          <div class="col-md-4 mb-4">
              <div class="card">
                  <a href=""><img src="oppo-a17k-1_200x200.jpg"></a>
                  <div class="card-body">
                      <p class="h6">Oppo A17k</p>
                      <div class="stars">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                      ...
                      <p class="h5 m-0">32,000 pkr</p>
                  </div>
              </div>
          </div>
          <div class="col-md-4 mb-4">
              <div class="card">
                  <a href=""><img src="vivo-iqoo-neo7-1_200x200.jpg"></a>
                  <div class="card-body">
                      <p class="h6"></br>Vivo IQOO Neo 7</p>
                      <div class="stars">
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
                        <span class="fa fa-star checked"></span>
          ...
          <div class="small-container">
            ...
            <div class="card-body">
              <div class="row">
                  <div class="col-md-4 mb-4">
                      <div class="card">
                        <a href=""><img src="oppo-reno9-pro-plus-1_200x200.jpg"></a>
                          <div class="card-body">
                              <p class="h6">Oppo Reno 9 Pro</p>
                              <div class="stars">
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
                  ...
                  <div class="col-md-4 mb-4">
                      <div class="card">
                          <a href=""><img src="vivo-y02-1_200x200.jpg"></a>
                          <div class="card-body">
                              <p class="h6">Vivo Y02</p>
                              <div class="stars">
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
                  ...
                  <div class="col-md-4 mb-4">
                      <div class="card">
                          <a href=""><img src="xiaomi-13-pro-black-1_200x200.jpg"></a>
                          <div class="card-body">
                              <p class="h6"></br>Xiaomi 13 pro</p>
                              <div class="stars">
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span>
